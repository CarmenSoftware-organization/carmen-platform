...
ตาม preference: **ไม่เขียนเทสต์ใหม่** ชุดเดิมทุกชุดต้องเขียว (baseline 144 ไฟล์ / 1244 เทสต์ — 1241 เป็นตัวเลขที่วัดจากคนละกิ่ง ซึ่ง `describe` block สอง block ถูกลบไปแล้ว)
