...
export const en = {
  ...
  pages: {
    ...
    platformMigration: {
      ...
      checksDescription: 'Compares what the code declares against what the database actually holds. The first five are read-only.',
      opRun: 'Run',
      ...
      opConfirmSeatPool: 'This writes real rows on business-unit licences inside an always-rolled-back transaction. Net effect is zero, but it holds locks on customer data while it runs.',
      consoleLastRun: 'Last run',
      ...
      ops: {
        ...
        checkSeatPoolView: { label: 'Check seat pool view', desc: 'Confirms seat counting still matches the design — writes for real, but always rolls back' },
      },
      statusTitle: 'Status',
      upToDate: 'Up to date',
      pendingCount: '{{count}} pending',
