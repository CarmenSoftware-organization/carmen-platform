...
export const th: Translations = {
  ...
  nav: {
    ...
    userPlatform: 'ผู้ใช้',
    platformMigrations: 'Migration แพลตฟอร์ม',
  ...
  pages: {
    ...
    licenseFeatures: {
      ...
      state: {
        ...
        inactive: 'ปิดขาย',
        inactiveHint: 'เลิกขายของใหม่ — กลุ่มที่ผูกไว้แล้วยังเก็บไว้ได้ แต่เพิ่มเข้ากลุ่มใหม่ไม่ได้',
        hide: 'ซ่อน',
        hideHint: 'หายจากแค็ตตาล็อกสนิท คีย์ที่ขายไปแล้วกลายเป็นคีย์กำพร้า',
      },
      moduleFeatureCount: 'ฟีเจอร์ {{count}} รายการ',
      moduleShowing: 'แสดง {{shown}} จาก {{total}}',
      moduleClosedCount: 'ปิดขาย {{count}}',
      moduleHiddenCount: 'ซ่อน {{count}}',
      affectedBu: '{{count}} BU',
      affectedBuTooltipOne: 'มีอยู่ใน {{count}} หน่วยธุรกิจ — ถ้าซ่อน หน่วยเหล่านี้จะเสียเมนูนี้ไป',
      affectedBuTooltipMany: 'มีอยู่ใน {{count}} หน่วยธุรกิจ — ถ้าซ่อน หน่วยเหล่านี้จะเสียเมนูนี้ไป',
      affectedBuHeader: 'หน่วยธุรกิจที่ถือสิทธิ์',
    ...
    emailSettings: {
      ...
      useDefaultNamed: 'ใช้ค่าเริ่มต้น ({{name}})',
      makeDefault: 'ตั้งเป็นค่าเริ่มต้น',
      discardRoutingDescription: 'การแก้ไขการจับคู่ที่ทำไว้ยังไม่ได้บันทึก',
      carries: 'รับสาย',
      ...
      laneMissingWarning: 'การจับคู่ยังชี้ไปโปรไฟล์ที่ไม่มีอยู่แล้ว — เส้นทางเหล่านี้ไม่มีปากส่ง',
      laneInactiveWarning: 'โปรไฟล์นี้ปิดใช้งานอยู่ แต่ยังมีเส้นทางวิ่งเข้ามา',
      noDefaultWarning: 'ยังไม่ได้เลือกโปรไฟล์เริ่มต้น — {{count}} เส้นทางยังไม่มีผู้ส่ง',
    ...
    platformMigration: {
      ...
      consoleTitle: 'คอนโซลการรัน',
      consoleRuns: '{{count}} รายการ',
      consoleClear: 'ล้าง',
      consoleCopyAll: 'คัดลอกทั้งหมด',
      consoleCopyRun: 'คัดลอก log ของ {{label}}',
      consoleCopied: 'คัดลอก log แล้ว',
      consoleCopyFailed: 'คัดลอกไม่สำเร็จ — กรุณาเลือกข้อความแล้วคัดลอกเอง',
      ...
      seedsWrites: 'เขียนข้อมูลจริง',
      checksTitle: 'ตรวจความต่างของข้อมูล',
      checksDescription: 'เทียบสิ่งที่โค้ดประกาศไว้กับสิ่งที่อยู่ในฐานข้อมูลจริง ไม่มีตัวไหนเขียนอะไรลงไป',
      opRun: 'รัน',
      opRunWithInput: 'รัน…',
      opMissing: 'ไม่มีสคริปต์ในรุ่นนี้',
      opReadonly: 'อ่านอย่างเดียว',
      opWrites: 'เขียนข้อมูลจริง',
      ...
      ops: {
        ...
        seedApplicationApi: { label: 'รายการอนุญาต API ของแอป', desc: 'แอปไหน (x-app-id) เรียก API ตัวไหนได้บ้าง' },
        ...
        checkApplicationApi: { label: 'ตรวจรายการอนุญาต API ของแอป', desc: 'หารายการที่ไฟล์ seed ประกาศแต่ฐานข้อมูลไม่มี และในทางกลับกัน' },
      },
      statusTitle: 'สถานะ',
      ...
      rawOutput: 'ผลลัพธ์ดิบจาก Prisma',
      stateUpToDate: 'migration ทุกตัวในรุ่นนี้ถูกปรับใช้กับฐานข้อมูลแพลตฟอร์มแล้ว',
      statePending: 'migration เหล่านี้มีอยู่ในรุ่นนี้ แต่ยังไปไม่ถึงฐานข้อมูล',
      stateUnknown: 'ฐานข้อมูลไม่ได้รายงานสถานะ migration กลับมา ดูผลลัพธ์ดิบด้านล่าง',
      deployButton: 'ปรับใช้ migration',
      deployConfirmTitle: 'ปรับใช้ migration ของแพลตฟอร์ม?',
      deployConfirmDescription: 'จะรัน migration ที่ค้างทั้งหมดกับฐานข้อมูลกลางที่ทุก cluster ใช้ร่วมกัน หยุดกลางคันไม่ได้',
      deploySuccess: 'ปรับใช้ migration สำเร็จ {{count}} รายการ',
      deployNothing: 'ไม่มี migration ค้าง ไม่ได้เปลี่ยนแปลงอะไร',
      resolveTitle: 'แก้ migration ที่ค้างสถานะ (ขั้นสูง)',
      resolveDescription: 'ทำเครื่องหมายใน _prisma_migrations ว่ารายการนี้รันสำเร็จหรือย้อนกลับแล้ว โดยไม่ได้รัน SQL ของมันจริง ใช้เมื่อ migration ล้มเหลวค้างจนบล็อกรายการถัดไป ถ้าเลือกผิดจะทำให้ migration ที่ไม่เคยรันถูกนับว่ารันแล้ว',
      migrationNameLabel: 'ชื่อ migration',
      migrationNamePlaceholder: '20260612000000_add_doc_version',
      migrationNameInvalid: 'รูปแบบไม่ถูกต้อง ต้องเป็นชื่อโฟลเดอร์ migration เช่น 20260612000000_add_doc_version',
      actionLabel: 'ทำเครื่องหมายเป็น',
      actionApplied: 'รันแล้ว (applied)',
      actionRolledBack: 'ย้อนกลับแล้ว (rolled-back)',
      resolveButton: 'แก้สถานะ',
      resolveConfirmTitle: 'แก้สถานะ migration?',
      resolveConfirmDescription: 'จะทำเครื่องหมาย {{name}} เป็น "{{action}}" ในฐานข้อมูลแพลตฟอร์ม การกระทำนี้ย้อนกลับเองไม่ได้',
      resolveSuccess: 'แก้สถานะ {{name}} เรียบร้อย',
      disabledOrSuperAdmin: 'API migration ของแพลตฟอร์มถูกปิดอยู่ หรือคุณไม่ใช่ผู้ดูแลระบบสูงสุด',
      alreadyRunning: 'มี migration ของแพลตฟอร์มกำลังทำงานอยู่ รอสักครู่แล้วลองใหม่',
    },
    tenantMigration: {
      ...
      // ── แก้ migration ที่ค้างสถานะ (ราย BU) ──
      resolve: 'แก้สถานะ',
      resolveTitle: 'แก้ migration ที่ค้างสถานะ',
      resolveFor: '{{name}} ({{code}})',
      resolveDescription: 'ทำเครื่องหมายใน _prisma_migrations ของฐานข้อมูล tenant นี้ว่ารายการนั้นรันสำเร็จหรือย้อนกลับแล้ว โดยไม่ได้รัน SQL ของมันจริง ใช้เมื่อ migration ล้มเหลวค้างจนบล็อกรายการถัดไป ถ้าเลือกผิดจะทำให้ migration ที่ไม่เคยรันถูกนับว่ารันแล้ว',
      migrationNameLabel: 'ชื่อ migration',
      migrationNamePlaceholder: '20260612000000_add_doc_version',
      migrationNameInvalid: 'รูปแบบไม่ถูกต้อง — ต้องเป็นชื่อโฟลเดอร์ migration เช่น 20260612000000_add_doc_version',
      actionLabel: 'ทำเครื่องหมายเป็น',
    ...
    platformConfig: {
      ...
      sectionPlatformMigration: 'ฐานข้อมูลแพลตฟอร์ม',
      migrationTitle: 'API migration ของฐานข้อมูลแพลตฟอร์ม',
      migrationDesc1: 'เปิด/ปิดเส้นทาง',
      migrationDesc2: ' ทั้งชุด · ค่านี้เคยเป็นตัวแปร env ของ backend-gateway และเขียนได้เฉพาะผู้ดูแลระบบสูงสุดเท่านั้น ไม่ใช่ผู้ถือสิทธิ์ platform_config.manage',
      migrationApi: 'สถานะ API',
      migrationApiOn: 'เปิดใช้งาน',
      migrationApiOff: 'ปิดอยู่',
      migrationCheckbox: 'เปิดใช้งาน API migration ของแพลตฟอร์ม',
      migrationHintOffStrong: 'ปิดอยู่',
      migrationHintOff: 'ทุกคำขอไปที่เส้นทางนี้ได้ 403 แม้ผู้เรียกจะเป็นผู้ดูแลระบบสูงสุดก็ตาม',
      migrationHintOnStrong: 'เปิดใช้งาน',
      migrationHintOn: 'ผู้ดูแลระบบสูงสุด (หรือ CI ที่ถือ deploy token) สั่งรัน prisma migrate deploy กับฐานข้อมูลกลางที่ทุก cluster ใช้ร่วมกันได้จากหน้าจอ',
      migrationNoteCache: 'ฝั่ง backend เก็บค่านี้ไว้ 60 วินาที การเปลี่ยนจึงมีผลภายในหนึ่งนาที ไม่ใช่ทันที',
      migrationApiEnabledToast: 'เปิดใช้งาน API migration ของแพลตฟอร์มแล้ว',
      migrationApiDisabledToast: 'ปิด API migration ของแพลตฟอร์มแล้ว',
      migrationConfirmTitle: 'เปิด API migration ของแพลตฟอร์ม?',
      migrationConfirmDescription: 'ผู้ดูแลระบบสูงสุดจะสั่งรัน migration กับฐานข้อมูลกลางของทุก cluster ได้จากหน้าจอ โดยไม่ต้องเข้าถึงเครื่องอีกต่อไป ปิดกลับได้ทุกเมื่อ',
      migrationConfirmAction: 'เปิดใช้งาน',
    ...
    superAdmins: {
      ...
      grantedVerb: 'ให้สิทธิ์เมื่อ',
      standingCountOne: 'มี 1 คนบนแพลตฟอร์มนี้ที่ข้ามการตรวจสิทธิ์ทุกข้อ',
      standingCountOther: 'มี {{count}} คนบนแพลตฟอร์มนี้ที่ข้ามการตรวจสิทธิ์ทุกข้อ',
      selfBadge: 'คุณ',
      cannotRemoveSelf: 'ถอดสิทธิ์ของตัวเองไม่ได้',
      removeAria: 'ถอดสิทธิ์ผู้ดูแลระบบสูงสุดของ {{name}}',
      rosterAria: 'ทะเบียนผู้ดูแลระบบสูงสุด',
    },
    userPlatform: {
      ...
      // ── UserPlatformEdit — สำนวนสิทธิ์รายบุคคล ──
      reachPlatformWide: 'เอื้อมถึงทั้งแพลตฟอร์ม',
      reachPlatformWideNote: 'ทุก cluster และทุก business unit',
      reachClusters: 'เอื้อมถึง {{count}} cluster',
      reachNone: 'ไม่มีสิทธิ์ระดับแพลตฟอร์ม',
      reachNoneNote: 'ผู้ใช้รายนี้ไม่ถือบทบาท Platform ใด และจะไม่ปรากฏในทะเบียน',
      grantProvenanceUnavailable: 'ยังไม่มีข้อมูลการมอบสิทธิ์',
      grantNoRecord: 'ไม่มีบันทึกการมอบสิทธิ์',
      selfGranted: 'มอบให้ตัวเอง',
      selfGrantedTitle: 'ผู้ใช้รายนี้เป็นคนมอบบทบาทนี้ให้บัญชีตัวเอง',
      emailUnverified: 'อีเมลยังไม่ยืนยัน',
      inactiveHolderDetail: 'บัญชีนี้ถูกปิดใช้งานแล้ว แต่ยังถือสิทธิ์ Platform อยู่ {{count}} รายการ',
      membershipTitle: 'สังกัด',
      membershipDescription: 'ที่ทางของผู้ใช้รายนี้ในโครงสร้างผู้เช่า — ไม่ใช่สิทธิ์ระดับแพลตฟอร์ม',
      membershipEmpty: 'ไม่ได้สังกัด cluster หรือ business unit ใด',
      membershipClusters: 'Cluster',
      membershipBusinessUnits: 'Business Unit',
      membershipNone: 'ไม่มี',
      addRoleDescription: 'มอบบทบาท Platform หนึ่งบทบาทที่ขอบเขตเดียว',
      scopePlatformHint: 'บทบาทมีผลกับทุก cluster',
      scopeClusterHint: 'บทบาทมีผลเฉพาะภายใน cluster ที่เลือก',
    ...
    applications: {
      ...
      reachAria: '{{name}}: {{count}} จาก {{total}} endpoint',
      reachFullAria: '{{name}}: เข้าถึงได้ครบทั้ง {{total}} endpoint',
      reachUnanchoredAria: '{{name}}: {{count}} endpoint',
      reachFullUnanchoredAria: '{{name}}: เข้าถึงได้ทุก endpoint',
      nModules: '{{count}} โมดูล',
      nModulesPlural: '{{count}} โมดูล',
      ...
      modulesReach: '{{count}} จาก {{total}} โมดูล',
      authorityCount: 'ลบหรืออนุมัติได้ {{count}}',
      authorityLegend: 'ในนี้มี {{count}} รายการที่ลบข้อมูลหรืออนุมัติแทนแอปนี้ได้',
      authorityTitle: '{{api}} — ลบข้อมูลหรือเลื่อนสถานะเอกสาร',
      untouchedModules: 'ยังไม่ได้แตะอีก {{count}} โมดูล',
      untouchedModulesPlural: 'ยังไม่ได้แตะอีก {{count}} โมดูล',
      untouchedModulesTitle: 'โมดูลที่ยังไม่ได้ให้สิทธิ์: {{modules}}',
      dormantGrants: 'ยังเก็บรายการจำกัดขอบเขตไว้ {{count}} รายการ จะกลับมามีผลเมื่อปิดสวิตช์นี้',
      selectedOfCatalog: 'เลือกแล้ว {{count}} จาก {{total}} endpoint',
      selectedCount: 'เลือกแล้ว {{count}} endpoint',
      staleGrantsTitle: 'มีอีก {{count}} รายการที่ให้สิทธิ์ไว้แต่ไม่มีอยู่ใน catalog ปัจจุบัน',
      dormantGrantsPlural: 'ยังเก็บรายการจำกัดขอบเขตไว้ {{count}} รายการ จะกลับมามีผลเมื่อปิดสวิตช์นี้',
    ...
    reportTemplates: {
      ...
      sourceTypeLabel: 'ประเภทแหล่งข้อมูล',
      ...
      removeFilterAria: 'เอาตัวกรอง {{label}} ออก',
      columnTemplateType: 'ประเภทเทมเพลต',
      ...
      fieldLabelTemplateType: 'ประเภทเทมเพลต',
    },
    reportFormGroups: {
    ...
    usageAnalytics: {
      subtitle: 'ภาพรวมการใช้งานจากข้อมูลการใช้งานหน้าจอ',
      noData: 'ไม่มีข้อมูล',
      emptyTitle: 'ยังไม่มีเหตุการณ์ในช่วงที่เลือก',
      emptyDescription: 'ลองขยายช่วงวัน หรือเอาตัวกรองหน่วยธุรกิจ / แอปพลิเคชันออก',
      eventTypeLabel: 'ประเภทเหตุการณ์',
      eventTypeClick: 'คลิก',
      eventTypePageView: 'เปิดหน้า',
      metricEvents: 'เหตุการณ์',
      metricClicks: 'การคลิก',
      metricPageViews: 'การเปิดหน้า',
      metricSessions: 'เซสชัน',
      metricActiveUsers: 'ผู้ใช้ที่ใช้งาน',
      csvDay: 'วัน',
      chartTitle: 'เซสชันและผู้ใช้ที่ใช้งาน รายวัน',
      topPages: 'หน้าที่ถูกเปิดมากที่สุด',
      topElements: 'องค์ประกอบที่ถูกคลิกมากที่สุด',
      topPageSub: '{{sessions}} เซสชัน · {{users}} ผู้ใช้',
    },
    activityTrail: {
    ...
    activityEvents: {
      subtitle: 'ข้อมูลการใช้งานหน้าจอรายเหตุการณ์ — ใครกดอะไร หน้าไหน เมื่อไหร่',
      searchLabel: 'ค้นหา',
      searchPlaceholder: 'เส้นทางหน้า / id องค์ประกอบ / ข้อความองค์ประกอบ',
      filtersDescription: 'กรองเหตุการณ์ตามหน่วยธุรกิจ, แอปพลิเคชัน, ประเภท, ผู้ใช้, หน้า และเซสชัน',
      eventTypeLabel: 'ประเภทเหตุการณ์',
      eventTypeClick: 'คลิก',
      eventTypePageView: 'เปิดหน้า',
      userIdLabel: 'ผู้ใช้ (User ID)',
      userIdPlaceholder: 'UUID ของผู้ใช้',
      pagePathLabel: 'เส้นทางหน้า',
      sessionIdLabel: 'รหัสเซสชัน',
      columnTime: 'เวลา',
      columnUser: 'ผู้ใช้',
      columnBu: 'หน่วยธุรกิจ',
      columnType: 'ประเภท',
      columnPage: 'หน้า',
      columnElement: 'องค์ประกอบ',
      columnApp: 'แอป',
      csvServerTime: 'เวลาฝั่งเซิร์ฟเวอร์',
      viewDetailsAria: 'ดูรายละเอียดเหตุการณ์ {{id}}',
      clearFilterAria: 'ล้างตัวกรอง {{label}}',
      chipSearch: 'ค้นหา: {{value}}',
      chipPage: 'หน้า: {{value}}',
      chipSession: 'เซสชัน: {{value}}…',
      chipUser: 'ผู้ใช้: {{value}}…',
      chipType: 'ประเภท: {{value}}',
      chipBu: 'หน่วยธุรกิจ: {{value}}',
      chipApp: 'แอป: {{value}}',
      emptyTitle: 'ไม่พบเหตุการณ์',
      emptyDescription: 'ลองขยายช่วงวัน หรือล้างตัวกรองบางตัวออก',
      detailTitle: 'รายละเอียดเหตุการณ์',
      detailDescription: 'ข้อมูลทุกฟิลด์ของเหตุการณ์ที่เลือก รวม props และ user agent',
      detailServerTime: 'เวลา (เซิร์ฟเวอร์)',
      detailClientTime: 'เวลา (ไคลเอนต์)',
      detailDomain: 'โดเมน',
      detailElementText: 'ข้อความองค์ประกอบ',
      detailSession: 'เซสชัน',
      // สามตัวนี้จงใจไม่แปล — เป็น **ชื่อฟิลด์ในข้อมูลจริง** ที่ผู้ใช้ต้องเอาไปเทียบกับ
      // payload/HTTP header ไม่ใช่ข้อความอธิบาย กฎเดียวกับรายการชนิดไฟล์ที่ common.upload
      // เว้นไว้ ที่เหลือใน namespace นี้แปลไทยหมดแล้ว อย่าอ่านสามบรรทัดนี้ว่าตกสำรวจ
      detailEventId: 'Event ID',
      detailProps: 'props',
      detailUserAgent: 'user agent',
      viewWholeSession: 'ดูเซสชันนี้ทั้งหมด',
    },
  },
  cronjob: {
    config: {
      daysBack: 'จำนวนวันย้อนหลัง',
      daysBackHint: 'จำนวนวันของกิจกรรมที่จะสรุปยอดในแต่ละครั้งที่รัน',
      retentionDays: 'จำนวนวันที่เก็บข้อมูล',
      retentionDaysHint: 'ข้อมูลที่เก่ากว่าจำนวนวันนี้จะถูกลบทิ้ง',
      batchSize: 'ขนาดชุดข้อมูล',
      batchSizeHint: 'จำนวนแถวสูงสุดที่ลบได้ในแต่ละชุด',
      action: 'การกระทำ',
      type: 'ประเภท',
      olderThan: 'เก่ากว่า',
      olderThanPlaceholder: 'เช่น 30d',
      olderThanHint: 'ระยะเวลาที่งานล้างข้อมูลเข้าใจได้ เช่น 30d, 90d, 1y',
      buCodes: 'หน่วยธุรกิจ',
      buCodesEmptyMeansAll: 'เว้นว่างไว้เพื่อรวมทุกหน่วยธุรกิจ',
      buCodesRequiredHint: 'จำเป็นต้องระบุ — เลือกอย่างน้อยหนึ่งหน่วยธุรกิจ ไม่งั้นการรันจะล้มเหลว',
      tier: 'ระดับ',
      tierAll: 'ทุกระดับ',
      title: 'หัวข้อ',
      message: 'ข้อความ',
      category: 'หมวดหมู่',
      userIds: 'ผู้ใช้ที่รับการแจ้งเตือน',
      userIdsLoadFailed: 'โหลดรายชื่อผู้ใช้ไม่สำเร็จ',
      userIdsNoneSelected: 'ยังไม่ได้เลือกผู้ใช้',
      userIdsNoneFound: 'ไม่พบผู้ใช้',
      userIdsEmptyMeansAll: 'เว้นว่างไว้เพื่อแจ้งเตือนผู้ใช้ทุกคน',
      userIdsRequiredHint: 'จำเป็นต้องระบุ — เลือกผู้ใช้อย่างน้อยหนึ่งคน ไม่งั้นการรันจะล้มเหลว',
      templateId: 'เทมเพลตรายงาน',
      templateIdPlaceholder: 'เลือกเทมเพลตรายงาน',
      templateIdLoadFailed: 'โหลดเทมเพลตรายงานไม่สำเร็จ',
      format: 'รูปแบบไฟล์',
      formatPlaceholder: 'เลือกรูปแบบไฟล์',
      filters: 'ตัวกรอง',
      filterKeyPlaceholder: 'คีย์',
      filterValuePlaceholder: 'ค่า',
      addFilter: 'เพิ่มตัวกรอง',
      removeFilterAria: 'นำตัวกรองออก',
      recipients: 'ผู้ใช้ที่รับรายงาน',
      recipientsHint: 'เลือกผู้ใช้ในระบบที่จะได้รับรายงานนี้',
      ...
      mailSourceInternal: 'ภายใน',
      mailSourceExternal: 'ภายนอก',
    },
    newTitle: 'สร้างงานตามเวลาใหม่',
    singularTitle: 'งานตามเวลา',
    notFoundTitle: 'ไม่พบงานตามเวลานี้',
    notFoundDescription: 'งานตามเวลานี้ไม่มีอยู่ หรืออาจถูกลบไปแล้ว ตรวจสอบลิงก์ หรือเลือกรายการใหม่จากรายการงานตามเวลา',
    ...
    section: {
      ...
      schedule: 'กำหนดเวลา',
      execution: 'การรัน',
      typeConfig: 'การตั้งค่าตามประเภทงาน',
    },
    field: {
      jobType: 'ประเภทงาน',
    ...
    type: {
      ...
      cleanup: 'ล้างข้อมูล',
      dashboard_refresh: 'รีเฟรชแดชบอร์ด',
      activity_rollup: 'สรุปยอดกิจกรรม',
      activity_retention: 'เก็บรักษากิจกรรม',
    },
    validation: {
      invalidCron: 'Cron expression นี้ไม่ถูกต้อง',
    },
    toast: {
      created: 'สร้างงานตามเวลาแล้ว',
      saved: 'บันทึกงานตามเวลาแล้ว',
      started: 'เริ่มงานตามเวลาแล้ว',
      stopped: 'หยุดงานตามเวลาแล้ว',
      dispatched: 'ส่งคำสั่งรันแล้ว — งานกำลังทำงานอยู่เบื้องหลัง',
      deleted: 'ลบงานตามเวลาแล้ว',
    },
    error: {
      foreignOwned: 'งานนี้เป็นของ {{service}} ไม่สามารถแก้ไขจากที่นี่ได้',
    },
    pluralTitle: 'งานตามเวลา',
    subtitle: 'งานที่ตั้งเวลาไว้ทำงานอัตโนมัติทั่วทั้งแพลตฟอร์ม เช่น รายงาน การแจ้งเตือน การล้างข้อมูล และงานบำรุงรักษาอื่น ๆ',
    addJob: 'เพิ่มงานตามเวลา',
    searchPlaceholder: 'ค้นหางานตามเวลา...',
    loadingAria: 'กำลังโหลดรายการงานตามเวลา',
    loading: 'กำลังโหลด...',
    emptyTitle: 'ยังไม่มีงานตามเวลา',
    emptyDescription: 'เพิ่มงานตามเวลาเพื่อให้ระบบทำรายงาน การแจ้งเตือน การล้างข้อมูล หรืองานประจำอื่น ๆ โดยอัตโนมัติ',
    column: {
      name: 'ชื่อ',
      type: 'ประเภท',
    ...
    summary: {
      ...
      running: 'กำลังทำงาน',
      stopped: 'หยุดทำงาน',
      withErrors: 'มีข้อผิดพลาด',
      foreignOwned: 'เป็นของ service อื่น',
      activeInScheduler: 'กำลังทำงานใน scheduler',
      pageScopeCaption: 'กำลังทำงาน หยุดทำงาน มีข้อผิดพลาด และเป็นของ service อื่น นับเฉพาะแถวที่โหลดในหน้านี้ — ทั้งหมดและกำลังทำงานใน scheduler นับรวมทุกงาน',
