...
export const th: Translations = {
  ...
  pages: {
    ...
    platformMigration: {
      ...
      checksDescription: 'เทียบสิ่งที่โค้ดประกาศไว้กับสิ่งที่อยู่ในฐานข้อมูลจริง ทุกตัวอ่านอย่างเดียว ดูป้ายที่ท้ายชื่อแต่ละแถวได้',
      opRun: 'รัน',
      opRunWithInput: 'รัน…',
      ...
      deployTitle: 'ปรับใช้ migration ที่ค้าง',
      deployDescription: 'รัน prisma migrate deploy กับฐานข้อมูลแพลตฟอร์ม ทำซ้ำได้ ถ้าไม่มีรายการค้างจะไม่เกิดอะไรขึ้น',
