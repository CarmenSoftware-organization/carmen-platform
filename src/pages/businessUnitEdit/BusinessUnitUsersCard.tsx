...
const BusinessUnitUsersCard: React.FC<BusinessUnitUsersCardProps> = ({ users }) => (
  <Card>
    <CardHeader>
                ...
                <tr key={u.id} className="zebra-row border-b last:border-0">
                  ...
                  <td className="px-4 py-2 text-center">
                    <div className="flex items-center justify-center gap-1">
                      <Button variant="ghost" size="icon" className="h-7 w-7" onClick={() => users.handleOpenEditUser(u)}>
                        <Pencil className="h-3.5 w-3.5" />
                      </Button>
                      <Button variant="ghost" size="icon" className="h-7 w-7 text-destructive hover:text-destructive" onClick={() => users.handleDeleteUser(u)}>
